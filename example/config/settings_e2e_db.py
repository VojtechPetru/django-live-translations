"""E2E test settings for Database backend.

Inherits from the base example settings. The DATABASE is overridden at
runtime by conftest fixtures so each test gets isolation.
"""
